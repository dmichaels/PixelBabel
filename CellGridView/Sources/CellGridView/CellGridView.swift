...
public class CellGridView: ObservableObject
{
                            ...
                            scaled: Bool = false)
    {
        ...
        self._buffer = Memory.allocate(self._viewWidth * self._viewHeight * Screen.shared.depth)
    ...
    public final func writeCell(viewCellX: Int, viewCellY: Int)
    {
        ...
        let offset: Int = ((self._cellSize * viewCellX) + shiftX +
                           (self._cellSizeTimesViewWidth * viewCellY + shiftY * self._viewWidth)) * Screen.shared.depth
